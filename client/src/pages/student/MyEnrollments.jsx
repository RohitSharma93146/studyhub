...
const MyEnrollments = () => {
  ...
  const [progress, setProgress] = useState([
    ...
    {lectureCompleted: 46, totalLectures: 67},
    {lectureCompleted: 45, totalLectures: 58},
    {lectureCompleted: 0, totalLectures: 5},
    {lectureCompleted: 2, totalLectures: 4},  
    {lectureCompleted: 3, totalLectures: 5},
    {lectureCompleted: 26, totalLectures: 34},
    {lectureCompleted: 35, totalLectures: 45},
            ...
            <tr key={index} className='border-b border-gray-500/20'>
              ...
              <td className='px-4 py-3 max-sm:text-right'>
                <button className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white rounded' onClick={()=> navigate('/player/' + course._id)}>
                  {progress[index] && progress[index].lectureCompleted /progress[index].totalLectures === 1 ? 'Completed' : 'On Going'}
                </button>
              </td>
            </tr>
          ))}
