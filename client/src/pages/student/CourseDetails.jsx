    ...
    <>
      <div className="flex md:flex-row flex-col reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">Course by <span className="text-blue-600 underline">Rohit Sharma</span></p>
        ...
        {/* right column */}
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] lg:min-w-[400px] xl:min-w-[650px]">
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Access to community and support</li>
                <li>Access to all future updates and new content</li>
              </ul>
            </div>
